...
public class ScoreControllerTest {
    ...
    public void testAddScore () throws  Exception {
        ...
        mockMvc.perform(post("/api/scores").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().isOk()).andDo(print());
    }
    ...
    public void testFailAddScoreWithInvalidData () throws  Exception {
        ...
        String json = ow.writeValueAsString(s1);
        mockMvc.perform(post("/api/scores").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().isBadRequest()).andDo(print());
    }
    ...
    public void testGetAllScores() throws Exception {
        ...
        this.mockMvc.perform(get("/api/scores/all")).andExpect(matchAll(status().isOk(),
    ...
    public void testGetScore() throws Exception {
        this.mockMvc.perform(get("/api/scores").param("id", scores.get(0).getId().toString()))
    ...
    public void testFailGetUnexistingScore() throws Exception {
        this.mockMvc.perform(get("/api/scores").param("id", UUID.randomUUID().toString()))
    ...
    public void testDeleteScore() throws Exception {
        ...
        this.mockMvc.perform(delete("/api/scores").param("id", scores.get(0).getId().toString()))
                .andExpect(status().isOk()).andDo(mvcResult -> mockMvc.perform(get("/api/scores/all"))
    ...
    public void testFailDeleteRemovedScore() throws Exception {
        this.mockMvc.perform(delete("/api/scores").param("username", scores.get(0).getId().toString())).andExpect(status().isBadRequest());
    }
    ...
    public void testGetScoreByUsername() throws Exception {
        ...
        this.mockMvc.perform(get("/api/scores/all/user").param("username", "John5"))
                .andExpect(status().isOk());
    }
    ...
    public void testFailGetScoreByUnexistingUsername() throws Exception {
        ...
        this.mockMvc.perform(get("/api/scores/all/user").param("username", "Fake name"))
                .andExpect(status().isBadRequest()).andDo(print());
    }
