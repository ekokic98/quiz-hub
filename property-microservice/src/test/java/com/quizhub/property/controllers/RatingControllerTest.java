...
public class RatingControllerTest {
    ...
    public void testAddRating () throws  Exception {
        ...
        mockMvc.perform(post("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().isOk()).andDo(print());
    }
    ...
    public void testFailAddRatingWithInvalidData () throws  Exception {
        ...
        String json = ow.writeValueAsString(c1);
        mockMvc.perform(post("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().isBadRequest()).andDo(print());
    }
    ...
    public void testGetAllRatings() throws Exception {
        ...
        this.mockMvc.perform(get("/api/ratings/all")).andExpect(matchAll(status().isOk(),
    ...
    public void testUpdateRating() throws Exception {
        ...
        mockMvc.perform(put("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().isOk());
    }
    ...
    public void testFailUpdateUnexistingRating() throws Exception {
        Rating c1 = new Rating(UUID.randomUUID(),UUID.fromString("b8888888-a15f-4eda-9d3b-e0e7ce2559a6"), UUID.fromString("debb8e88-88ba-4320-b0a1-29779fc54648"), 5);
        String json = ow.writeValueAsString(c1);
        mockMvc.perform(put("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json))
    ...
    public void testGetRating() throws Exception {
        ...
        this.mockMvc.perform(get("/api/ratings").param("id", ratings.get(0).getId().toString()))
    ...
    public void testFailGetUnexistingRating() throws Exception {
        this.mockMvc.perform(get("/api/ratings").param("id", UUID.randomUUID().toString()))
                .andExpect(status().isBadRequest()).andDo(print());
    }
    ...
    public void testDeleteRating() throws Exception {
        ...
        this.mockMvc.perform(delete("/api/ratings").param("id", ratings.get(0).getId().toString()))
                .andExpect(status().isOk()).andDo(mvcResult -> mockMvc.perform(get("/api/ratings/all"))
    ...
    public void testFailDeleteRemovedRating() throws Exception {
        this.mockMvc.perform(delete("/api/ratings").param("username", ratings.get(0).getId().toString())).andExpect(status().isBadRequest());
    }
    ...
    public void testRatingContentValidation() throws Exception {
        ...
        mockMvc.perform(post("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().isBadRequest())
                .andDo(mvcResult -> {mockMvc.perform(post("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json2)).andExpect(status().isBadRequest());});
    }
    ...
    public void testFailAddSameRating () throws  Exception {
        Rating c1 = new Rating(UUID.randomUUID(),UUID.fromString("b8888888-a15f-4eda-9d3b-e0e7ce2559a6"), UUID.fromString("debb8e88-88ba-4320-b0a1-29779fc54648"), 5);
        String json = ow.writeValueAsString(c1);
        mockMvc.perform(post("/api/ratings").contentType(MediaType.APPLICATION_JSON).content(json)).andExpect(status().is4xxClientError()).andDo(print());
    }
    ...
    public void testGetFavoriteByUsername() throws Exception {
        ...
        this.mockMvc.perform(get("/api/ratings/all/user").param("username", "Anna5"))
